...
distribute_images() {
  ...
  gcloud compute images create u16-poc-asia-east1 --source-image u16-poc-us-west1 --source-image-project gcp-dn-poc --storage-location asia-east1
  gcloud compute images create u16-poc-europe-west2 --source-image u16-poc-us-west1 --source-image-project gcp-dn-poc --storage-location europe-west2
}
